...
export async function Navbar({ locale }: { locale: Locale }) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-3 py-2 sm:gap-3 sm:px-5 md:px-6 md:py-3">
        ...
        <nav className="flex min-w-0 items-center gap-3 sm:gap-5">
          ...
          <Link
            ...
            className="shrink-0 whitespace-nowrap rounded-btn border-[1.5px] border-ink bg-white px-3 py-2 text-sm font-bold text-ink transition hover:bg-ink hover:text-canvas sm:px-5"
          >
